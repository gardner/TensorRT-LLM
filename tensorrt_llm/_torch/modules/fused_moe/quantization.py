...
class NVFP4CutlassFusedMoEMethod(NVFP4FusedMoEMethod):
    ...
    def load_expert_w3_w1_weight_scale_nvfp4(
        ...
        # Use tensor.data_ptr(); constructing a TypedStorage wrapper can hang on
        # GB10 UMA-backed CUDA tensors during cold-start weight loading.
    ...
    def load_expert_w3_w1_weight(self,
        ...
        assert expert_idx >= 0, "expert_idx must be provided for stable dict key"
        # See load_expert_w3_w1_weight_scale_nvfp4 for why tensor.data_ptr()
        # is used instead of going through TypedStorage.
